...
namespace DyanmicSample
{
	...
	class ReadOnlyFile : DynamicObject
	{
		...
		// Implement the TryInvokeMember method of the DynamicObject class for dynamic
		// member calls that have arguments.
		public override bool TryInvokeMember(InvokeMemberBinder binder, object[] args, out object result)
		{
			StringSearchOption StringSearchOption = DyanmicSample.StringSearchOption.StartsWith;
			bool trimSpaces = true;
